note
	description: "[
		Concrete storage for INTEGER_32 (int32) data.
		Wraps a standard Eiffel ARRAY [INTEGER_32] for safety and interoperability.
	]"
...
feature {NONE} -- Initialization
	...
	make_from_array (arr: ARRAY [INTEGER_32])
...
feature -- Access
	...
	item_as_int_64 (index: INTEGER_32): INTEGER_64
		...
		do
			(create {EXCEPTIONS}).raise ("Type mismatch: storage is INTEGER_32")
		end
